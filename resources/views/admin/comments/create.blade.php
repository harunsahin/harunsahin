                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('source') is-invalid @enderror" id="source" name="source" required>
                                        ...
                                        <option value="Booking.com" {{ old('source') == 'Booking.com' ? 'selected' : '' }}>Booking.com</option>
                                        <option value="Google" {{ old('source') == 'Google' ? 'selected' : '' }}>Google</option>
                                        <option value="Hotels.com" {{ old('source') == 'Hotels.com' ? 'selected' : '' }}>Hotels.com</option>
                                        <option value="Otelpuan" {{ old('source') == 'Otelpuan' ? 'selected' : '' }}>Otelpuan</option>
                                    </select>
                                    @error('source')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('comment_date') is-invalid @enderror" id="comment_date" name="comment_date" value="{{ old('comment_date', date('Y-m-d')) }}" required>
                                    @error('comment_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('position') is-invalid @enderror" id="position" name="position" value="{{ old('position', 0) }}" required>
                                    @error('position')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
